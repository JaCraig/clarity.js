...
describe("Framework.Router.HashPart tests", function() {
   it("should actually have Framework.Router.HashPart defined", function() {
     expect(Framework.Router.HashPart).toBeDefined();
  });
  it("can be created with everything provided", function() {
     var value = new Framework.Router.HashPart('asdf', { });
