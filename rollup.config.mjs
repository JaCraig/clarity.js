...
export default [
        ...
        plugins: [
            copy({
                assets: [
                    ...
                    { source: "index2.html", destination: "./index2.html" },
                ],
            }),
        ],
    },
    // Image files
    {
        ...
        plugins: [copy({ assets: [{ source: "./", destination: "./" }] })],
    },
    // CSS files
    {
        input: "src/less/main.less",
        output: [{ file: "dist/Clarity.css" }],
        plugins: [postcss({ extract: true, plugins: [autoprefixer()] })],
    },
    // CSS files min
    {
        input: "src/less/main.less",
        ...
        plugins: [
            ...
            copy({
                assets: [
                    { source: "../../node_modules/@fortawesome/fontawesome-free/webfonts", destination: "./webfonts" },
                ],
            }),
        ],
    },
    // Node and package system builds
    {
        ...
        plugins: [
            ...
            multi(),
            alias({
                entries: [{ find: "vue", replacement: "vue/dist/vue.js" }],
            }),
