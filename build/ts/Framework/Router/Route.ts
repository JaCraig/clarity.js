...
/// <reference path="PathPart.ts" />
/// <reference path="QueryPart.ts" />
/// <reference path="HashPart.ts" />
...
module Framework.Router {
    ...
    export class Route {
        ...
        // Constructor
        constructor(url: string, callback: (parameters: Types.StringDictionary<any>) => void, defaultValues?: Types.StringDictionary<any>){
            if(defaultValues === undefined) {
                defaultValues = new Types.StringDictionary<any>();
            }
        ...
        private defaultValues: Types.StringDictionary<any>;

        // URL that matches with the individual route
        private url: string;

        // Callback function to call
        private callbacks: { (parameters: Types.StringDictionary<any>): void }[];
        ...
        public addCallback(callback: (parameters: Types.StringDictionary<any>) => void): void {
            this.callbacks.push(callback);
        }

        // removes a callback from the route
        public removeCallback(callback: (parameters: Types.StringDictionary<any>) => void): void {
        ...
        private getParametersFromUrl(pathParts: string[], queryParts: string[], hashParts: string[]): Types.StringDictionary<any> {
            let parameters = new Types.StringDictionary<any>();
