...
/// <reference path="./Interfaces/IHotkeys.ts" />

module Framework.Hotkey {

    // Defines the hotkeys system
    export class Hotkeys implements Interfaces.IHotkeys {
        // constructor
        constructor() {
            this.scopes = { };
            ...
            this.filter = x => {
                let tagName = (<Element>x.target || x.srcElement).tagName;
        ...
        private scopes: Types.StringDictionary<Scope>;
        ...
        public bind(keyCodes: string, callback: (event: KeyboardEvent, handler: any) => void): Interfaces.IHotkeys {
